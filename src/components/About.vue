<template>
  <div id="about">
      <h1>Introduction</h1>
      As a shareholder, you have a say in how bitshares operates. Many decisions are made about the network, improvements the gui, additional features, worker proposals etc. These are important decisions, but oftentimes, if you are new to an organization, it's difficult to know who is actively involved in making decisions that are in your best interest. It's also possible that you own very few BTS and as a result may now feel as if your vote makes a difference.
